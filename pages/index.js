  ...
  return (
    <div className={styles.container}>
      ...
      <div className='flex items-center justify-center'>
        ...
        {loading ?
          <button onClick={signInFunction} className="text-white bg-gradient-to-r from-cyan-400 to-blue-600 font-medium rounded-lg text-lg px-8 py-4 text-center mb-4">
          ...
          :
          <button onClick={signInFunction} className="text-white bg-gradient-to-r from-cyan-400 to-blue-600 font-medium rounded-lg text-lg px-12 py-4 text-center mb-4">Login Using Metamask</button>
        }
      </div>
      <p className="text-center text-sm font-normal text-gray-500 dark:text-gray-400">Learn more about MetaMask account — <a className='underline underline-offset-8' href='#'>Know More</a></p>
