          ...
          <div className="m-auto max-w-sm rounded overflow-hidden">
            ...
            <div className="px-6 py-2">
              <div className="font-bold text-md relative">
                <input
                  ...
                  maxLength={'30'}
                  type="text"
                  className="border-0 border-b-2 border-gray-100 rounded-t-lg w-full text-md text-gray-900 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder="NFT Title - Dhoni finishes off in style"
                />
              </div>
            ...
            <div className="px-5">
              <span className="inline-block bg-gray-200 rounded-full px-1 pl-5 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">
                <input
                  type="date"
                  className="bg-transparent w-full datepicker-input"
