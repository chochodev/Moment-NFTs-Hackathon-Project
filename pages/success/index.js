        ...
        <div>
          <div className="flex flex-col items-center space-y-2">
            ...
            <h1 className="text-4xl font-bold">
              Your moment is now{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-cyan-400">
                Eternal
              </span>
            </h1>
            <p>
              It might take upto a day for your NFT to be displayed on OpenSea
            </p>
            <a
            ...
            >
              <span className="text-sm font-medium">View in OpenSea</span>
            </a>
          </div>
        </div>
      </div>
